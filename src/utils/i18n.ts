...
const lazyTranslations = {
  en: {
    ...
    dataStoredInCloud: 'Data synced to cloud',
    ...
    itemsWaiting: 'item waiting',
    itemsWaiting_plural: 'items waiting',
    syncOffline: 'Offline',
    ...
    migrateConfirmTitle: 'Migrate data to cloud?',
    migrateConfirmMessage:
      'This will upload all your local data to Supabase. Make sure you want to sync your data across devices.',
  ...
  ru: {
    ...
    dataStoredInCloud: 'Данные синхронизированы с облаком',
    ...
    itemsWaiting: 'элемент в очереди',
    itemsWaiting_plural: 'элемента в очереди',
    syncOffline: 'Оффлайн',
    ...
    migrateConfirmTitle: 'Перенести данные в облако?',
    migrateConfirmMessage:
      'Это загрузит все ваши локальные данные в Supabase. Убедитесь, что хотите синхронизировать данные между устройствами.',
