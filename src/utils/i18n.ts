...
const lazyTranslations = {
  en: {
    ...
    spendingCalendarTitle: 'Spending Calendar',
    inflows: 'Inflows',
    outflows: 'Outflows',
    net: 'Net',
    ...
    csvAccount: 'Account',
    csvAccountAmount: 'Account amount',
    csvAccountCurrency: 'Account currency',
    csvCategoryOrSource: 'Category / Source',
    csvToAccount: 'To account',
    csvToAmount: 'To amount',
    csvToAccountCurrency: 'To account currency',
    csvMainCurrencyAmount: 'Amount in main currency',
    csvLoanPerson: 'Loan person',
    csvComment: 'Comment',
    csvTypeIncome: 'Income',
    csvTypeExpense: 'Expense',
    csvTypeTransfer: 'Transfer',
    csvTypeLoanGiven: 'Loan given',
    csvTypeLoanReceived: 'Loan received',
    csvTypeLoanPayment: 'Loan payment',
    ...
    amountInMainCurrency: 'main currency amount',
  ...
  ru: {
    ...
    spendingCalendarTitle: 'Календарь трат',
    inflows: 'Поступления',
    outflows: 'Расходы',
    net: 'Чистый',
    ...
    csvCurrency: 'Валюта',
    csvAccount: 'Счёт',
    csvAccountAmount: 'Сумма по счёту',
    csvAccountCurrency: 'Валюта счёта',
    csvCategoryOrSource: 'Категория / Источник',
    csvToAccount: 'Счёт получателя',
    csvToAmount: 'Сумма получения',
    csvToAccountCurrency: 'Валюта счёта получателя',
    csvMainCurrencyAmount: 'Сумма в основной валюте',
    csvLoanPerson: 'Долг (кто)',
    csvComment: 'Комментарий',
    csvTypeIncome: 'Доход',
    csvTypeExpense: 'Расход',
    csvTypeTransfer: 'Перевод',
    csvTypeLoanGiven: 'Дал в долг',
    csvTypeLoanReceived: 'Взял в долг',
    csvTypeLoanPayment: 'Погашение долга',
    ...
    amountInMainCurrency: 'сумма в основной валюте',
    relatedAccount: 'Счёт',
    none: 'Нет',
